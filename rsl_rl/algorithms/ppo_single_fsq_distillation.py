...
from rsl_rl.modules import ActorCritic, ActorCriticCNN, ActorCriticRecurrent, ActorCriticSingleFSQ, ActorCriticSingleFSQDistillation
from rsl_rl.modules.rnd import RandomNetworkDistillation
from rsl_rl.storage import RLDistillationRolloutStorage
from rsl_rl.utils import string_to_callable
from rsl_rl.algorithms import PPOSingleFSQ
...
class PPOSingleFSQDistillation(PPOSingleFSQ):
    ...
    def __init__(
        ...
        self.transition = RLDistillationRolloutStorage.Transition()
    ...
    def update(self) -> dict[str, float]:
        ...
        mean_robot_motion_fsq_c_loss = 0
        # RND loss
        ...
        for (
            ...
            BC_kl = self.policy.kl_divergence(mu_batch, sigma_batch, old_teacher_mu_batch.detach(), old_teacher_sigma_batch.detach()).mean()
        ...
        mean_robot_motion_fsq_c_loss /= num_updates
        ...
        loss_dict = {
            ...
            "robot_motion_fsq_c": mean_robot_motion_fsq_c_loss,
            "behavior clone": mean_behavior_loss,
        }
        if self.rnd:
